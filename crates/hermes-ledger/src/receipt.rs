...
use hermes_primitives::{ComputeUnits, Hash, Signature, Slot};

/// A signed summary of one slot authored by the Hermes leader.
///
/// Receipts are what make Hermes auditable in public: anyone can replay the
...
impl Receipt {
    ...
    pub fn signing_payload(&self) -> Vec<u8> {
        ...
        buf.extend_from_slice(b"hermes:receipt:v1");
