//! # hermes-primitives
//!
//! Core primitive types for **Hermes**, the chain that writes itself.
//!
//! Hermes is **Solana-native**: it runs the SVM (Sealevel) runtime, addresses
...
//! vocabulary the rest of the protocol (`hermes-runtime`, `hermes-consensus`,
//! `hermes-ledger`) is written in.
//!
