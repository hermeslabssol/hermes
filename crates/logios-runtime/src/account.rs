...
use logios_primitives::{Lamports, Pubkey};
use std::collections::HashMap;

/// An SVM account: the only place state lives in Logios.
///
...
///
/// On a real validator this would be backed by AccountsDB-on-disk; for Logios
